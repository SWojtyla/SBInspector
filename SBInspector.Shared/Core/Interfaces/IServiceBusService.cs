...
public interface IServiceBusService
{
    ...
    // CRUD operations
    Task<bool> DeleteMessageAsync(string entityName, long sequenceNumber, string messageType = "Active", bool isSubscription = false, string? topicName = null, string? subscriptionName = null);
    ...
    Task<bool> RescheduleMessageAsync(string entityName, long sequenceNumber, DateTime newScheduledTime, string messageType = "Active", bool isSubscription = false, string? topicName = null, string? subscriptionName = null);
